...
function AttributesGetInstance(props) {
    ...
    const [endpoint, setEndpoint] = useState('/attributes/');
    useEffect(() => {
        setEndpoint(`/attributes/${instanceId}`);
    }, [instanceId]);
    ...
    return (
        <Layout
            form={(<div>
                <div className="form__title">Attributes - Get Instance</div>
                {isLoading ? <div className="form__field">Loading...</div> : <>
                    <div className="form__field">
                        <label>Instance</label>
                        <Selector id={instanceId} setId={setInstanceId} options={options['attributes']} />
                    </div>
...
export default AttributesGetInstance;